...
namespace HeatingCameraSystem.Master.Services
{
    ...
    public interface IDialogService
    {
        ...
        /// <summary>
        /// 프로그램 재시작 동의를 받는다. 물어볼 수 없는 환경(headless·테스트)에서는 false를 돌려주므로
        /// 재시작이 일어나지 않는다.
        /// </summary>
        bool ConfirmRestart(string message) => false;
    }
    ...
    public sealed class MessageBoxDialogService : IDialogService
    {
        ...
        public bool ConfirmRestart(string message)
            => OnUi(() => MessageBox.Show(
                message,
                LocalizationManager.Instance["Sim_RestartTitle"],
